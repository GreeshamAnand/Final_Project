ANAND_GREESHAM_Rfunction <- function() {
  library(ggplot2)
  library(lubridate)
  ...
  write.csv(submission, file = "anand_greesham_submission.csv", row.names=FALSE)
  ...
  p1 <- ggsave("anand_greesham_feature_importance.png", p)
  return(p1)
